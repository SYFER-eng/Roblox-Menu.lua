...
-- FOV Toggle  
AimbotSection:NewToggle("Show FOV Circle", "Toggle the visibility of the FOV circle", function(state)  
...
UserInputService.InputBegan:Connect(function(input)  
  if input.KeyCode == Enum.KeyCode.Insert then  
    local isVisible = MenuPopup.Visible  
    MenuPopup.Visible = not isVisible  -- Toggle the visibility of the menu popup  
    -- Toggle visibility for all sections of the menu
    CombatTab.Visible = not isVisible
    VisualTab.Visible = not isVisible
  end  
end)  
